...
There are a lot of things that make programming easy. Not all of it is about coding! There are a lot of tools outside of the text editor that make programming easier.

Many of them are console tools. So you'll learn how to use the console. You'll look like a hacker from a movie! (But be warned: It's actually quite boring and simple.) You also need to know about [Git]{link| url = https://git-scm.com/ } and [GitHub]{link| url = https://github.com/ } which will help you not lose code, share it and collaborate with other people. And speaking of collaboration, when you get stuck and need help, you should know a thing or two about how to ask a good question. Yes, really. And I'll also show you where to ask it.
...
There is also some required literature that is absolutely essential to every programmer. No debates, put your time in and read it all.