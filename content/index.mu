...
Many of them are [console]{ref| path = /console } tools. So you'll learn how to use the console. You'll look like a hacker from a movie! (But be warned: It's actually quite boring and simple.) You also need to know about [Git]{link| url = https://git-scm.com/ } and [GitHub]{link| url = https://github.com/ } which will help you not lose code, share it and collaborate with other people. And speaking of collaboration, when you get stuck and need help, you should know a thing or two about how to ask a good question. Yes, really. And I'll also show you where to ask it.
